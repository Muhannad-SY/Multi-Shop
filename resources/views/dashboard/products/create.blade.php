                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="exampleInputPassword1h">Product Descraption</label>
                                <textarea type="text" class="form-control" rows="2" name="description" required id="exampleInputPassword1h">{{ old('description') }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1t">Product Inside-Descraption</label>
                                <textarea type="text" class="form-control" rows="5" name="in_description" required id="exampleInputPassword1t">{{ old('in_description') }}</textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" 
                                    name="discount_price" id="exampleInputPassword1" value="{{old('discount_price')}}">
                            </div>
                            <div class="form-group">
